<template>
  <div class="cart">
    <Header></Header>
    <div class="cart-info">
      <h3 class="cart-top">购物车结算 &nbsp;&nbsp;<span>共<span style="color: red">{{ total_num }}</span>件商品</span></h3>

      <div class="cart-title">
        <el-row>
          <el-col :span="2">&nbsp;</el-col>
          <el-col :span="18" class="title1">商品</el-col>
          <el-col :span="4" class="title2">价格</el-col>
        </el-row>
      </div>

      <div class="cart-item" v-for="phone in phone_list">
        <el-row>
          <el-col :span="2" class="checkbox">&nbsp;&nbsp;</el-col>
          <el-col :span="18" class="phone-info">
  ...
  methods: {
    ...
    get_select_phone() {
      this.$axios.get(this.$settings.HOST + "cart/order/", {
        ...
        this.total_num = res.data.phone_list.length;
      })
    },
...
.phone_name, .real_price, .original_price {
  display: inline-block;
  line-height: 140%;
}
